...
Todo el material está disponible en este [[https://github.com/oscarperpinan/r-intro-eoi][repositorio]]. Consta de una presentación, código R, y datos de ejemplo. La presentación se puede leer en formato [[https://github.com/oscarperpinan/r-intro-eoi/blob/master/intro.pdf?raw%3Dtrue][PDF]], [[https://github.com/oscarperpinan/r-intro-eoi/blob/master/intro.org][org-mode]], o [[https://github.com/oscarperpinan/r-intro-eoi/blob/master/intro.tex][LaTeX]]. El código R está disponible [[https://github.com/oscarperpinan/r-intro-eoi/blob/master/intro.R][aquí]]. El fichero de datos está [[https://github.com/oscarperpinan/r-intro-eoi/blob/master/data/aranjuez.csv][aquí]]. 
